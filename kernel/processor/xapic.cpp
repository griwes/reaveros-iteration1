...
void processor::xapic::ipi(uint64_t apic_id, processor::ipis ipi_type, uint8_t data)
{
    ...
    switch (ipi_type)
    {
        ...
        case ipis::generic:
            _register(_interrupt_command_0, data);
            break;
...
void processor::xapic::broadcast(processor::broadcasts btype, processor::ipis ipi_type, uint8_t data)
{
    switch (ipi_type)
    {
        case ipis::generic:
            _register(_interrupt_command_0, (static_cast<uint64_t>(btype) << 18) | data);
            break;
